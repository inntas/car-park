          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="#">Lantai 2</a>
              </div>
            </div>
          </div>
        </nav>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-center">
              <p><span class="fw-bold spansatu">Selamat datang <span class="spandua">di Lantai 2</span> !</span> Parkirin mobil Anda di warna Hijau yaa...</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="konten container-fluid text-center">
        ...
        <div class="container-fluid text-center mt-5">
          ...
          <div class="row mt-5">
            ...
            <div class="col-sm">
              <div id="slot1">
                <div class="fs-4 pt-3 fw-bold">1</div>
              </div>
            </div>
            <div class="col-sm" >
              <div id="slot2">
                <div class="fs-4 pt-3 fw-bold">2</div>
              </div>
            </div>
            <div class="col-sm">
              <div id="slot3">
                <div class="fs-4 pt-3 fw-bold">3</div>
              </div>
            </div>
            <div class="col-sm">
              <div id="slot4">
                <div class="fs-4 pt-3 fw-bold">4</div>
              </div>
            </div>
            <div class="col-sm">
              <span>
